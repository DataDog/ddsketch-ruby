...
module Datadog
  module DDSketch
    ...
    class LogCollapsingHighestDenseSketch < BaseDDSketch
      def initialize(
        ...
        super(
          ...
          store: CollapsingHighestDenseStore.new(bin_limit: bin_limit),
          negative_store: CollapsingHighestDenseStore.new(bin_limit: bin_limit)
        )
      end
    end
  end
